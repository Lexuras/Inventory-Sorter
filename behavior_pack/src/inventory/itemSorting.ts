...
const CATEGORY_RULES: Array<{ rank: number; patterns: RegExp[] }> = [
  {
    rank: 0,
    patterns: [
...
export function sortStacks(stacks: SortableStack[]): SortableStack[] {
...
function categoryRank(typeId: string): number {
